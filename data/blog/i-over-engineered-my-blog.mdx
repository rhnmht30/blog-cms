...
slug: "i-over-engineered-my-blog"
...
<figure>
	...
	<figcaption>
		A screenshot of a timer with three months added on it, slowly increasing in
		reverse order.
	</figcaption>
</figure>
...
<span className="sr-only">
	...
	proper layouts, newsletters section, MDX integration, API for the newsletter,
	RSS and sitemap, accessibility, analytics, SEO, animations and
	micro-interactions.
</span>
...
function getFileData(filePath) {
	...
	const mdxSource = await renderToString(content, {
		components: { img: CustomImage, code: MyCodeBlock }, // pass them here
		mdxOptions: {
			remarkPlugins: [
...
<figure>
	...
	<figcaption>
		A screenshot showing low lighthouse score because of large blocking time.
	</figcaption>
</figure>
